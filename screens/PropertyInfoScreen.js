...
import { pixelNormalize } from "../ultis/pixelNormalise";
import { MaterialIcons } from "@expo/vector-icons";
import Amenities from "../components/Amenities";

export const PropertyInfoScreen = () => {
  ...
  return (
    <>
        ...
        <ScrollView>
          ...
          <View style={styles.priceContainer}>
            <Text style={styles.oldPrice}>
              US$ {route.params.oldPrice * route.params.adults}
            </Text>
            <Text style={{ fontSize: 20, fontWeight: "bold" }}>
              US$ {route.params.newPrice * route.params.adults}
            </Text>
          </View>

          <View style={styles.priceOffTag}>
      ...
      <Pressable
        ...
        style={styles.selectAvailabiltyBtn}
      >
        <Text
          style={{
            textAlign: "center",
...
const styles = StyleSheet.create({
  ...
  infoText: { fontSize: 16, fontWeight: "bold", color: "#007FFF" },
  selectAvailabiltyBtn: {
